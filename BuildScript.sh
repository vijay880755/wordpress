...
docker login -u AWS -p $(aws ecr get-login-password --region ap-south-1) 765771042989.dkr.ecr.ap-south-1.amazonaws.comdocker tag clever-tap-wordpressdocker_wordpress 765771042989.dkr.ecr.ap-south-1.amazonaws.com/clever-tap:wordpress_$1
